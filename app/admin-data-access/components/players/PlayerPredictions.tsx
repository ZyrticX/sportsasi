...
export default function PlayerPredictions({ userId, games }: PlayerPredictionsProps) {
  ...
  return (
    <div className="mt-4">
      <h3 className="text-lg font-bold mb-2">ניחושים של השחקן</h3>
